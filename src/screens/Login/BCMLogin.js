        ...
        >
          <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
            <View style={styles.formContainer}>
              <Text style={styles.title}>BCM Log In</Text>
              <Text style={styles.subtitle}>Kindly provide Log in Id and Password to Log In</Text>
              <View style={styles.warningContainer}>
                <Text style={styles.warningText}>
                  For security reasons, please log in through the web app.
                </Text>
              </View>
              <Input
                headerText="Login ID"
              ...
              <PrimaryButton 
                title="Log In" 
                onPress={handleLogin} 
                disabled={true || !loginId || !password} 
              />
            </View>
          </ScrollView>
        </KeyboardAvoidingView>
